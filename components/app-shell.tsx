  ...
  return (
    <div className="mx-auto flex min-h-svh w-full bg-background">
      ...
      <aside className="sticky top-0 hidden h-svh w-64 shrink-0 flex-col border-r border-border bg-sidebar px-4 py-6 lg:flex">
        ...
        >
          <Avatar src={currentUser.photo} alt={currentUser.name} size="sm" online />
      ...
      {/* Mobile bottom nav */}
      <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-card/90 backdrop-blur-lg lg:hidden">
